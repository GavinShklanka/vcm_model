...
const DOMAIN_STORIES = {
  ...
  'Public Education': [
    { step: 1, label: 'The Finding',  icon: '📊',
      content: 'Distraction (33.1% severity) outranks impairment (32.1%) — and distraction is 3× more prevalent. The Distracted Commuter intervention profile (7.7% of crashes) is the deadliest segment.',
    ...
    { step: 4, label: 'The Outcome',  icon: '✅',
      content: 'Primary goal: normalize the summer-is-dangerous message against entrenched winter-focused public perception. Secondary: reduce distraction prevalence in the 7.7% highest-severity intervention profile.',
  ...
  'Winter Maintenance': [
    { step: 1, label: 'The Finding',  icon: '📊',
      content: 'Weather and surface severity rank features are among the V2 model\'s key inputs. Environment Canada issues forecasts with 6–24hr lead time — enough to act proactively on high-risk corridors.',
      stat: '8', statLabel: 'Final model features' },
    { step: 2, label: 'The Evidence', icon: '🔍',
  ...
  'Data + Monitoring': [
    ...
    { step: 2, label: 'The Evidence', icon: '🔍',
      content: 'The ensemble\'s temporal holdout test (Aug 2025 – Jan 2026 vs earlier training) achieved 0.6576 AUC — credible but dependent on the feature distribution of recent data. New months add new seasonal patterns.',
      stat: '0.6576', statLabel: 'Ensemble validated AUC' },
    { step: 3, label: 'The Action',   icon: '📊',
      content: 'Establish quarterly pipeline: (1) ingest new NS GeoJSON records, (2) run Scripts 04-06 (feature engineering + training), (3) compare new AUC to 0.6576 baseline, (4) deploy if AUC ≥ 0.640.',
